 ...
 * Stub hash: 06d9c5cd5ee36e717f4e499dc27688271b6c20eb */
...
static const zend_function_entry ext_functions[] = {
	ZEND_RAW_FENTRY("sodium_crypto_aead_aes256gcm_is_available", zif_sodium_crypto_aead_aes256gcm_is_available, arginfo_sodium_crypto_aead_aes256gcm_is_available, 0, NULL, "/**\n * Check if hardware supports AES256-GCM\n * @return bool\n */")
#if defined(HAVE_AESGCM)
	ZEND_RAW_FENTRY("sodium_crypto_aead_aes256gcm_decrypt", zif_sodium_crypto_aead_aes256gcm_decrypt, arginfo_sodium_crypto_aead_aes256gcm_decrypt, 0, NULL, "/**\n * Verify then decrypt a message with AES-256-GCM\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_aes256gcm_encrypt", zif_sodium_crypto_aead_aes256gcm_encrypt, arginfo_sodium_crypto_aead_aes256gcm_encrypt, 0, NULL, "/**\n * Encrypt then authenticate with AES-256-GCM\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_aes256gcm_keygen", zif_sodium_crypto_aead_aes256gcm_keygen, arginfo_sodium_crypto_aead_aes256gcm_keygen, 0, NULL, "/**\n * Generate a random AES-256-GCM key\n * @return string\n */")
#endif
#if defined(crypto_aead_aegis128l_KEYBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_aead_aegis128l_decrypt", zif_sodium_crypto_aead_aegis128l_decrypt, arginfo_sodium_crypto_aead_aegis128l_decrypt, 0, NULL, "/**\n * Verify then decrypt a message with AEGIS-128L\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_aegis128l_encrypt", zif_sodium_crypto_aead_aegis128l_encrypt, arginfo_sodium_crypto_aead_aegis128l_encrypt, 0, NULL, "/**\n * Encrypt then authenticate a message with AEGIS-128L\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_aegis128l_keygen", zif_sodium_crypto_aead_aegis128l_keygen, arginfo_sodium_crypto_aead_aegis128l_keygen, 0, NULL, "/**\n * Generate a random AEGIS-128L key\n * @return string\n */")
#endif
#if defined(crypto_aead_aegis256_KEYBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_aead_aegis256_decrypt", zif_sodium_crypto_aead_aegis256_decrypt, arginfo_sodium_crypto_aead_aegis256_decrypt, 0, NULL, "/**\n * Verify then decrypt a message with AEGIS-256\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_aegis256_encrypt", zif_sodium_crypto_aead_aegis256_encrypt, arginfo_sodium_crypto_aead_aegis256_encrypt, 0, NULL, "/**\n * Encrypt then authenticate a message with AEGIS-256\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_aegis256_keygen", zif_sodium_crypto_aead_aegis256_keygen, arginfo_sodium_crypto_aead_aegis256_keygen, 0, NULL, "/**\n * Generate a random AEGIS-256 key\n * @return string\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_aead_chacha20poly1305_decrypt", zif_sodium_crypto_aead_chacha20poly1305_decrypt, arginfo_sodium_crypto_aead_chacha20poly1305_decrypt, 0, NULL, "/**\n * Verify then decrypt with ChaCha20-Poly1305\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_chacha20poly1305_encrypt", zif_sodium_crypto_aead_chacha20poly1305_encrypt, arginfo_sodium_crypto_aead_chacha20poly1305_encrypt, 0, NULL, "/**\n * Encrypt then authenticate with ChaCha20-Poly1305\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_chacha20poly1305_keygen", zif_sodium_crypto_aead_chacha20poly1305_keygen, arginfo_sodium_crypto_aead_chacha20poly1305_keygen, 0, NULL, "/**\n * Generate a random ChaCha20-Poly1305 key.\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_chacha20poly1305_ietf_decrypt", zif_sodium_crypto_aead_chacha20poly1305_ietf_decrypt, arginfo_sodium_crypto_aead_chacha20poly1305_ietf_decrypt, 0, NULL, "/**\n * Verify that the ciphertext includes a valid tag\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_chacha20poly1305_ietf_encrypt", zif_sodium_crypto_aead_chacha20poly1305_ietf_encrypt, arginfo_sodium_crypto_aead_chacha20poly1305_ietf_encrypt, 0, NULL, "/**\n * Encrypt a message\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_chacha20poly1305_ietf_keygen", zif_sodium_crypto_aead_chacha20poly1305_ietf_keygen, arginfo_sodium_crypto_aead_chacha20poly1305_ietf_keygen, 0, NULL, "/**\n * Generate a random ChaCha20-Poly1305 (IETF) key.\n * @return string\n */")
#if defined(crypto_aead_xchacha20poly1305_IETF_NPUBBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_aead_xchacha20poly1305_ietf_decrypt", zif_sodium_crypto_aead_xchacha20poly1305_ietf_decrypt, arginfo_sodium_crypto_aead_xchacha20poly1305_ietf_decrypt, 0, NULL, "/**\n * (Preferred) Verify then decrypt with XChaCha20-Poly1305\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_xchacha20poly1305_ietf_keygen", zif_sodium_crypto_aead_xchacha20poly1305_ietf_keygen, arginfo_sodium_crypto_aead_xchacha20poly1305_ietf_keygen, 0, NULL, "/**\n * Generate a random XChaCha20-Poly1305 key.\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_aead_xchacha20poly1305_ietf_encrypt", zif_sodium_crypto_aead_xchacha20poly1305_ietf_encrypt, arginfo_sodium_crypto_aead_xchacha20poly1305_ietf_encrypt, 0, NULL, "/**\n * (Preferred) Encrypt then authenticate with XChaCha20-Poly1305\n * @return string\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_auth", zif_sodium_crypto_auth, arginfo_sodium_crypto_auth, 0, NULL, "/**\n * Compute a tag for the message\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_auth_keygen", zif_sodium_crypto_auth_keygen, arginfo_sodium_crypto_auth_keygen, 0, NULL, "/**\n * Generate a random key for sodium_crypto_auth\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_auth_verify", zif_sodium_crypto_auth_verify, arginfo_sodium_crypto_auth_verify, 0, NULL, "/**\n * Verifies that the tag is valid for the message\n * @return bool\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box", zif_sodium_crypto_box, arginfo_sodium_crypto_box, 0, NULL, "/**\n * Authenticated public-key encryption\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_keypair", zif_sodium_crypto_box_keypair, arginfo_sodium_crypto_box_keypair, 0, NULL, "/**\n * Randomly generate a secret key and a corresponding public key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_seed_keypair", zif_sodium_crypto_box_seed_keypair, arginfo_sodium_crypto_box_seed_keypair, 0, NULL, "/**\n * Deterministically derive the key pair from a single key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_keypair_from_secretkey_and_publickey", zif_sodium_crypto_box_keypair_from_secretkey_and_publickey, arginfo_sodium_crypto_box_keypair_from_secretkey_and_publickey, 0, NULL, "/**\n * Create a unified keypair string from a secret key and public key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_open", zif_sodium_crypto_box_open, arginfo_sodium_crypto_box_open, 0, NULL, "/**\n * Authenticated public-key decryption\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_publickey", zif_sodium_crypto_box_publickey, arginfo_sodium_crypto_box_publickey, 0, NULL, "/**\n * Extract the public key from a crypto_box keypair\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_publickey_from_secretkey", zif_sodium_crypto_box_publickey_from_secretkey, arginfo_sodium_crypto_box_publickey_from_secretkey, 0, NULL, "/**\n * Calculate the public key from a secret key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_seal", zif_sodium_crypto_box_seal, arginfo_sodium_crypto_box_seal, 0, NULL, "/**\n * Anonymous public-key encryption\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_seal_open", zif_sodium_crypto_box_seal_open, arginfo_sodium_crypto_box_seal_open, 0, NULL, "/**\n * Anonymous public-key decryption\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_box_secretkey", zif_sodium_crypto_box_secretkey, arginfo_sodium_crypto_box_secretkey, 0, NULL, "/**\n * Extracts the secret key from a crypto_box keypair\n * @return string\n */")
#if defined(crypto_core_ristretto255_HASHBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_add", zif_sodium_crypto_core_ristretto255_add, arginfo_sodium_crypto_core_ristretto255_add, 0, NULL, "/**\n * Adds an element\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_from_hash", zif_sodium_crypto_core_ristretto255_from_hash, arginfo_sodium_crypto_core_ristretto255_from_hash, 0, NULL, "/**\n * Maps a vector\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_is_valid_point", zif_sodium_crypto_core_ristretto255_is_valid_point, arginfo_sodium_crypto_core_ristretto255_is_valid_point, 0, NULL, "/**\n * Determines if a point on the ristretto255 curve\n * @return bool\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_random", zif_sodium_crypto_core_ristretto255_random, arginfo_sodium_crypto_core_ristretto255_random, 0, NULL, "/**\n * Generates a random key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_add", zif_sodium_crypto_core_ristretto255_scalar_add, arginfo_sodium_crypto_core_ristretto255_scalar_add, 0, NULL, "/**\n * Adds a scalar value\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_complement", zif_sodium_crypto_core_ristretto255_scalar_complement, arginfo_sodium_crypto_core_ristretto255_scalar_complement, 0, NULL, "/**\n * The sodium_crypto_core_ristretto255_scalar_complement purpose\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_invert", zif_sodium_crypto_core_ristretto255_scalar_invert, arginfo_sodium_crypto_core_ristretto255_scalar_invert, 0, NULL, "/**\n * Inverts a scalar value\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_mul", zif_sodium_crypto_core_ristretto255_scalar_mul, arginfo_sodium_crypto_core_ristretto255_scalar_mul, 0, NULL, "/**\n * Multiplies a scalar value\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_negate", zif_sodium_crypto_core_ristretto255_scalar_negate, arginfo_sodium_crypto_core_ristretto255_scalar_negate, 0, NULL, "/**\n * Negates a scalar value\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_random", zif_sodium_crypto_core_ristretto255_scalar_random, arginfo_sodium_crypto_core_ristretto255_scalar_random, 0, NULL, "/**\n * Generates a random key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_reduce", zif_sodium_crypto_core_ristretto255_scalar_reduce, arginfo_sodium_crypto_core_ristretto255_scalar_reduce, 0, NULL, "/**\n * Reduces a scalar value\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_scalar_sub", zif_sodium_crypto_core_ristretto255_scalar_sub, arginfo_sodium_crypto_core_ristretto255_scalar_sub, 0, NULL, "/**\n * Subtracts a scalar value\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_core_ristretto255_sub", zif_sodium_crypto_core_ristretto255_sub, arginfo_sodium_crypto_core_ristretto255_sub, 0, NULL, "/**\n * Subtracts an element\n * @return string\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_kx_keypair", zif_sodium_crypto_kx_keypair, arginfo_sodium_crypto_kx_keypair, 0, NULL, "/**\n * Creates a new sodium keypair\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kx_publickey", zif_sodium_crypto_kx_publickey, arginfo_sodium_crypto_kx_publickey, 0, NULL, "/**\n * Extract the public key from a crypto_kx keypair\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kx_secretkey", zif_sodium_crypto_kx_secretkey, arginfo_sodium_crypto_kx_secretkey, 0, NULL, "/**\n * Extract the secret key from a crypto_kx keypair.\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kx_seed_keypair", zif_sodium_crypto_kx_seed_keypair, arginfo_sodium_crypto_kx_seed_keypair, 0, NULL, "/**\n * Description\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kx_client_session_keys", zif_sodium_crypto_kx_client_session_keys, arginfo_sodium_crypto_kx_client_session_keys, 0, NULL, "/**\n * Calculate the client-side session keys.\n * @return array\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kx_server_session_keys", zif_sodium_crypto_kx_server_session_keys, arginfo_sodium_crypto_kx_server_session_keys, 0, NULL, "/**\n * Calculate the server-side session keys.\n * @return array\n */")
	ZEND_RAW_FENTRY("sodium_crypto_generichash", zif_sodium_crypto_generichash, arginfo_sodium_crypto_generichash, 0, NULL, "/**\n * Get a hash of the message\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_generichash_keygen", zif_sodium_crypto_generichash_keygen, arginfo_sodium_crypto_generichash_keygen, 0, NULL, "/**\n * Generate a random generichash key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_generichash_init", zif_sodium_crypto_generichash_init, arginfo_sodium_crypto_generichash_init, 0, NULL, "/**\n * Initialize a hash for streaming\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_generichash_update", zif_sodium_crypto_generichash_update, arginfo_sodium_crypto_generichash_update, 0, NULL, "/**\n * Add message to a hash\n * @return true\n */")
	ZEND_RAW_FENTRY("sodium_crypto_generichash_final", zif_sodium_crypto_generichash_final, arginfo_sodium_crypto_generichash_final, 0, NULL, "/**\n * Complete the hash\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kdf_derive_from_key", zif_sodium_crypto_kdf_derive_from_key, arginfo_sodium_crypto_kdf_derive_from_key, 0, NULL, "/**\n * Derive a subkey\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_kdf_keygen", zif_sodium_crypto_kdf_keygen, arginfo_sodium_crypto_kdf_keygen, 0, NULL, "/**\n * Generate a random root key for the KDF interface\n * @return string\n */")
#if defined(crypto_pwhash_SALTBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_pwhash", zif_sodium_crypto_pwhash, arginfo_sodium_crypto_pwhash, 0, NULL, "/**\n * Derive a key from a password, using Argon2\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_pwhash_str", zif_sodium_crypto_pwhash_str, arginfo_sodium_crypto_pwhash_str, 0, NULL, "/**\n * Get an ASCII-encoded hash\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_pwhash_str_verify", zif_sodium_crypto_pwhash_str_verify, arginfo_sodium_crypto_pwhash_str_verify, 0, NULL, "/**\n * Verifies that a password matches a hash\n * @return bool\n */")
#endif
#if SODIUM_LIBRARY_VERSION_MAJOR > 9 || (SODIUM_LIBRARY_VERSION_MAJOR == 9 && SODIUM_LIBRARY_VERSION_MINOR >= 6)
	ZEND_RAW_FENTRY("sodium_crypto_pwhash_str_needs_rehash", zif_sodium_crypto_pwhash_str_needs_rehash, arginfo_sodium_crypto_pwhash_str_needs_rehash, 0, NULL, "/**\n * Determine whether or not to rehash a password\n * @return bool\n */")
#endif
#if defined(crypto_pwhash_scryptsalsa208sha256_SALTBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_pwhash_scryptsalsa208sha256", zif_sodium_crypto_pwhash_scryptsalsa208sha256, arginfo_sodium_crypto_pwhash_scryptsalsa208sha256, 0, NULL, "/**\n * Derives a key from a password, using scrypt\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_pwhash_scryptsalsa208sha256_str", zif_sodium_crypto_pwhash_scryptsalsa208sha256_str, arginfo_sodium_crypto_pwhash_scryptsalsa208sha256_str, 0, NULL, "/**\n * Get an ASCII encoded hash\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_pwhash_scryptsalsa208sha256_str_verify", zif_sodium_crypto_pwhash_scryptsalsa208sha256_str_verify, arginfo_sodium_crypto_pwhash_scryptsalsa208sha256_str_verify, 0, NULL, "/**\n * Verify that the password is a valid password verification string\n * @return bool\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_scalarmult", zif_sodium_crypto_scalarmult, arginfo_sodium_crypto_scalarmult, 0, NULL, "/**\n * Compute a shared secret given a user\'s secret key and another user\'s public key\n * @return string\n */")
#if defined(crypto_core_ristretto255_HASHBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_scalarmult_ristretto255", zif_sodium_crypto_scalarmult_ristretto255, arginfo_sodium_crypto_scalarmult_ristretto255, 0, NULL, "/**\n * Computes a shared secret\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_scalarmult_ristretto255_base", zif_sodium_crypto_scalarmult_ristretto255_base, arginfo_sodium_crypto_scalarmult_ristretto255_base, 0, NULL, "/**\n * Calculates the public key from a secret key\n * @return string\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_secretbox", zif_sodium_crypto_secretbox, arginfo_sodium_crypto_secretbox, 0, NULL, "/**\n * Authenticated shared-key encryption\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretbox_keygen", zif_sodium_crypto_secretbox_keygen, arginfo_sodium_crypto_secretbox_keygen, 0, NULL, "/**\n * Generate random key for sodium_crypto_secretbox\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretbox_open", zif_sodium_crypto_secretbox_open, arginfo_sodium_crypto_secretbox_open, 0, NULL, "/**\n * Authenticated shared-key decryption\n * @return string|false\n */")
#if defined(crypto_secretstream_xchacha20poly1305_ABYTES)
	ZEND_RAW_FENTRY("sodium_crypto_secretstream_xchacha20poly1305_keygen", zif_sodium_crypto_secretstream_xchacha20poly1305_keygen, arginfo_sodium_crypto_secretstream_xchacha20poly1305_keygen, 0, NULL, "/**\n * Generate a random secretstream key.\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretstream_xchacha20poly1305_init_push", zif_sodium_crypto_secretstream_xchacha20poly1305_init_push, arginfo_sodium_crypto_secretstream_xchacha20poly1305_init_push, 0, NULL, "/**\n * Initialize a secretstream context for encryption\n * @return array\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretstream_xchacha20poly1305_push", zif_sodium_crypto_secretstream_xchacha20poly1305_push, arginfo_sodium_crypto_secretstream_xchacha20poly1305_push, 0, NULL, "/**\n * Encrypt a chunk of data so that it can safely be decrypted in a streaming API\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretstream_xchacha20poly1305_init_pull", zif_sodium_crypto_secretstream_xchacha20poly1305_init_pull, arginfo_sodium_crypto_secretstream_xchacha20poly1305_init_pull, 0, NULL, "/**\n * Initialize a secretstream context for decryption\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretstream_xchacha20poly1305_pull", zif_sodium_crypto_secretstream_xchacha20poly1305_pull, arginfo_sodium_crypto_secretstream_xchacha20poly1305_pull, 0, NULL, "/**\n * Decrypt a chunk of data from an encrypted stream\n * @return array|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_secretstream_xchacha20poly1305_rekey", zif_sodium_crypto_secretstream_xchacha20poly1305_rekey, arginfo_sodium_crypto_secretstream_xchacha20poly1305_rekey, 0, NULL, "/**\n * Explicitly rotate the key in the secretstream state\n * @return void\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_shorthash", zif_sodium_crypto_shorthash, arginfo_sodium_crypto_shorthash, 0, NULL, "/**\n * Compute a short hash of a message and key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_shorthash_keygen", zif_sodium_crypto_shorthash_keygen, arginfo_sodium_crypto_shorthash_keygen, 0, NULL, "/**\n * Get random bytes for key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign", zif_sodium_crypto_sign, arginfo_sodium_crypto_sign, 0, NULL, "/**\n * Sign a message\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_detached", zif_sodium_crypto_sign_detached, arginfo_sodium_crypto_sign_detached, 0, NULL, "/**\n * Sign the message\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_ed25519_pk_to_curve25519", zif_sodium_crypto_sign_ed25519_pk_to_curve25519, arginfo_sodium_crypto_sign_ed25519_pk_to_curve25519, 0, NULL, "/**\n * Convert an Ed25519 public key to a Curve25519 public key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_ed25519_sk_to_curve25519", zif_sodium_crypto_sign_ed25519_sk_to_curve25519, arginfo_sodium_crypto_sign_ed25519_sk_to_curve25519, 0, NULL, "/**\n * Convert an Ed25519 secret key to a Curve25519 secret key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_keypair", zif_sodium_crypto_sign_keypair, arginfo_sodium_crypto_sign_keypair, 0, NULL, "/**\n * Randomly generate a secret key and a corresponding public key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_keypair_from_secretkey_and_publickey", zif_sodium_crypto_sign_keypair_from_secretkey_and_publickey, arginfo_sodium_crypto_sign_keypair_from_secretkey_and_publickey, 0, NULL, "/**\n * Join a secret key and public key together\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_open", zif_sodium_crypto_sign_open, arginfo_sodium_crypto_sign_open, 0, NULL, "/**\n * Check that the signed message has a valid signature\n * @return string|false\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_publickey", zif_sodium_crypto_sign_publickey, arginfo_sodium_crypto_sign_publickey, 0, NULL, "/**\n * Extract the Ed25519 public key from a keypair\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_secretkey", zif_sodium_crypto_sign_secretkey, arginfo_sodium_crypto_sign_secretkey, 0, NULL, "/**\n * Extract the Ed25519 secret key from a keypair\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_publickey_from_secretkey", zif_sodium_crypto_sign_publickey_from_secretkey, arginfo_sodium_crypto_sign_publickey_from_secretkey, 0, NULL, "/**\n * Extract the Ed25519 public key from the secret key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_seed_keypair", zif_sodium_crypto_sign_seed_keypair, arginfo_sodium_crypto_sign_seed_keypair, 0, NULL, "/**\n * Deterministically derive the key pair from a single key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_sign_verify_detached", zif_sodium_crypto_sign_verify_detached, arginfo_sodium_crypto_sign_verify_detached, 0, NULL, "/**\n * Verify signature for the message\n * @return bool\n */")
	ZEND_RAW_FENTRY("sodium_crypto_stream", zif_sodium_crypto_stream, arginfo_sodium_crypto_stream, 0, NULL, "/**\n * Generate a deterministic sequence of bytes from a seed\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_stream_keygen", zif_sodium_crypto_stream_keygen, arginfo_sodium_crypto_stream_keygen, 0, NULL, "/**\n * Generate a random sodium_crypto_stream key.\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_stream_xor", zif_sodium_crypto_stream_xor, arginfo_sodium_crypto_stream_xor, 0, NULL, "/**\n * Encrypt a message without authentication\n * @return string\n */")
#if defined(crypto_stream_xchacha20_KEYBYTES)
	ZEND_RAW_FENTRY("sodium_crypto_stream_xchacha20", zif_sodium_crypto_stream_xchacha20, arginfo_sodium_crypto_stream_xchacha20, 0, NULL, "/**\n * Expands the key and nonce into a keystream of pseudorandom bytes\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_stream_xchacha20_keygen", zif_sodium_crypto_stream_xchacha20_keygen, arginfo_sodium_crypto_stream_xchacha20_keygen, 0, NULL, "/**\n * Returns a secure random key\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_stream_xchacha20_xor", zif_sodium_crypto_stream_xchacha20_xor, arginfo_sodium_crypto_stream_xchacha20_xor, 0, NULL, "/**\n * Encrypts a message using a nonce and a secret key (no authentication)\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_crypto_stream_xchacha20_xor_ic", zif_sodium_crypto_stream_xchacha20_xor_ic, arginfo_sodium_crypto_stream_xchacha20_xor_ic, 0, NULL, "/**\n * Encrypts a message using a nonce and a secret key (no authentication)\n * @return string\n */")
#endif
	ZEND_RAW_FENTRY("sodium_add", zif_sodium_add, arginfo_sodium_add, 0, NULL, "/**\n * Add large numbers\n * @return void\n */")
	ZEND_RAW_FENTRY("sodium_compare", zif_sodium_compare, arginfo_sodium_compare, 0, NULL, "/**\n * Compare large numbers\n * @return int\n */")
	ZEND_RAW_FENTRY("sodium_increment", zif_sodium_increment, arginfo_sodium_increment, 0, NULL, "/**\n * Increment large number\n * @return void\n */")
	ZEND_RAW_FENTRY("sodium_memcmp", zif_sodium_memcmp, arginfo_sodium_memcmp, 0, NULL, "/**\n * Test for equality in constant-time\n * @return int\n */")
	ZEND_RAW_FENTRY("sodium_memzero", zif_sodium_memzero, arginfo_sodium_memzero, 0, NULL, "/**\n * Overwrite a string with NUL characters\n * @return void\n */")
	ZEND_RAW_FENTRY("sodium_pad", zif_sodium_pad, arginfo_sodium_pad, 0, NULL, "/**\n * Add padding data\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_unpad", zif_sodium_unpad, arginfo_sodium_unpad, 0, NULL, "/**\n * Remove padding data\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_bin2hex", zif_sodium_bin2hex, arginfo_sodium_bin2hex, 0, NULL, "/**\n * Encode to hexadecimal\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_hex2bin", zif_sodium_hex2bin, arginfo_sodium_hex2bin, 0, NULL, "/**\n * Decodes a hexadecimally encoded binary string\n * @return string\n */")
#if defined(sodium_base64_VARIANT_ORIGINAL)
	ZEND_RAW_FENTRY("sodium_bin2base64", zif_sodium_bin2base64, arginfo_sodium_bin2base64, 0, NULL, "/**\n * Encodes a raw binary string with base64.\n * @return string\n */")
	ZEND_RAW_FENTRY("sodium_base642bin", zif_sodium_base642bin, arginfo_sodium_base642bin, 0, NULL, "/**\n * Decodes a base64-encoded string into raw binary.\n * @return string\n */")
#endif
	ZEND_RAW_FENTRY("sodium_crypto_scalarmult_base", zif_sodium_crypto_box_publickey_from_secretkey, arginfo_sodium_crypto_scalarmult_base, 0, NULL, "/**\n * Alias sodium_crypto_box_publickey_from_secretkey\n */")
#if defined(crypto_ipcrypt_KEYBYTES)
