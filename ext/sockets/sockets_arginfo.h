 ...
 * Stub hash: c033a06dbc6ede3a1e51d754749143a9cf835411 */

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_select, 0, 4, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(1, read, IS_ARRAY, 1, "The sockets listed in the read array will be watched to see if characters become available for reading (more precisely, to see if a read will not block - in particular, a socket is also ready on end-of-file, in which case a socket_read will return a zero length string).")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(1, write, IS_ARRAY, 1, "The sockets listed in the write array will be watched to see if a write will not block.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(1, except, IS_ARRAY, 1, "The sockets listed in the except array will be watched for exceptions.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, seconds, IS_LONG, 1, "The seconds and microseconds together form the timeout parameter. The timeout is an upper bound on the amount of time elapsed before socket_select return. seconds may be zero , causing socket_select to return immediately. This is useful for polling. If seconds is null (no timeout), socket_select can block indefinitely.")
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_create_listen, 0, 1, Socket, MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, port, IS_LONG, 0, "The port on which to listen on all interfaces.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, backlog, IS_LONG, 0, "SOMAXCONN", "The backlog parameter defines the maximum length the queue of pending connections may grow to. SOMAXCONN may be passed as backlog parameter, see socket_listen for more information.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_accept, 0, 1, Socket, MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_set_nonblock, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create or socket_accept.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_write, 0, 2, MAY_BE_LONG|MAY_BE_FALSE)
	...
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, data, IS_STRING, 0, "The buffer to be written.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, length, IS_LONG, 1, "null", "The optional parameter length can specify an alternate length of bytes written to the socket. If this length is greater than data's length, it is silently truncated to the length of data.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_read, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create or socket_accept.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, length, IS_LONG, 0, "The maximum number of bytes read is specified by the length parameter. Otherwise you can use \\r,  , or \\0 to end reading (depending on the mode parameter, see below).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, mode, IS_LONG, 0, "PHP_BINARY_READ", "Optional mode parameter is a named constant: PHP_BINARY_READ (Default) - use the system recv() function. Safe for reading binary data. PHP_NORMAL_READ - reading stops at   or \\r.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_create, 0, 3, Socket, MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, domain, IS_LONG, 0, "The domain parameter specifies the protocol family to be used by the socket.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, type, IS_LONG, 0, "The type parameter selects the type of communication to be used by the socket.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, protocol, IS_LONG, 0, "The protocol parameter sets the specific protocol within the specified domain to be used when communicating on the returned socket. The proper value can be retrieved by name by using getprotobyname. If the desired protocol is TCP, or UDP the corresponding constants SOL_TCP, and SOL_UDP can also be used.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_connect, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, address, IS_STRING, 0, "The address parameter is either an IPv4 address in dotted-quad notation (e.g. 127.0.0.1) if socket is AF_INET, a valid IPv6 address (e.g. ::1) if IPv6 support is enabled and socket is AF_INET6 or the pathname of a Unix domain socket, if the socket family is AF_UNIX.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, port, IS_LONG, 1, "null", "The port parameter is only used and is mandatory when connecting to an AF_INET or an AF_INET6 socket, and designates the port on the remote host to which a connection should be made.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_strerror, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, error_code, IS_LONG, 0, "A valid socket error number, likely produced by socket_last_error.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_bind, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, address, IS_STRING, 0, "If the socket is of the AF_INET family, the address is an IP in dotted-quad notation (e.g. 127.0.0.1).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, port, IS_LONG, 0, "0", "The port parameter is only used when binding an AF_INET socket, and designates the port on which to listen for connections.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_recv, 0, 4, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "The socket must be a Socket instance previously created by socket_create.")
	ZEND_ARG_INFO(1, data)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, length, IS_LONG, 0, "Up to length bytes will be fetched from remote host.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, flags, IS_LONG, 0, "The value of flags can be any combination of the following flags, joined with the binary OR (|) operator.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_send, 0, 4, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create or socket_accept.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, data, IS_STRING, 0, "A buffer containing the data that will be sent to the remote host.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, length, IS_LONG, 0, "The number of bytes that will be sent to the remote host from data.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, flags, IS_LONG, 0, "The value of flags can be any combination of the following flags, joined with the binary OR (|) operator. Possible values for flags MSG_OOB Send OOB (out-of-band) data. MSG_EOR Indicate a record mark. The sent data completes the record. MSG_EOF Close the sender side of the socket and include an appropriate notification of this at the end of the sent data. The sent data completes the transaction. MSG_DONTROUTE Bypass routing, use direct interface.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_sendto, 0, 5, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created using socket_create.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, data, IS_STRING, 0, "The sent data will be taken from buffer data.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, length, IS_LONG, 0, "length bytes from data will be sent.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, flags, IS_LONG, 0, "The value of flags can be any combination of the following flags, joined with the binary OR (|) operator. Possible values for flags MSG_OOB Send OOB (out-of-band) data. MSG_EOR Indicate a record mark. The sent data completes the record. MSG_EOF Close the sender side of the socket and include an appropriate notification of this at the end of the sent data. The sent data completes the transaction. MSG_DONTROUTE Bypass routing, use direct interface.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, address, IS_STRING, 0, "IP address of the remote host.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, port, IS_LONG, 1, "null", "port is the remote port number at which the data will be sent.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_get_option, 0, 3, MAY_BE_ARRAY|MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create or socket_accept.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, level, IS_LONG, 0, "The level parameter specifies the protocol level at which the option resides. For example, to retrieve options at the socket level, a level parameter of SOL_SOCKET would be used. Other levels, such as TCP, can be used by specifying the protocol number of that level. Protocol numbers can be found by using the getprotobyname function.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, option, IS_LONG, 0, "Reports whether the socket lingers on socket_close if data is present. By default, when the socket is closed, it attempts to send all unsent data. In the case of a connection-oriented socket, socket_close will wait for its peer to acknowledge the data.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_set_option, 0, 4, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create or socket_accept.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, level, IS_LONG, 0, "The level parameter specifies the protocol level at which the option resides. For example, to set options at the socket level, a level parameter of SOL_SOCKET would be used. Other levels, such as TCP, can be used by specifying the protocol number of that level. Protocol numbers can be found by using the getprotobyname function.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, option, IS_LONG, 0, "The available socket options are the same as those for the socket_get_option function.")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_create_pair, 0, 4, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, domain, IS_LONG, 0, "The domain parameter specifies the protocol family to be used by the socket. See socket_create for the full list.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, type, IS_LONG, 0, "The type parameter selects the type of communication to be used by the socket. See socket_create for the full list.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, protocol, IS_LONG, 0, "The protocol parameter sets the specific protocol within the specified domain to be used when communicating on the returned socket. The proper value can be retrieved by name by using getprotobyname. If the desired protocol is TCP, or UDP the corresponding constants SOL_TCP, and SOL_UDP can also be used.")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_shutdown, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO_DOCCOMMENT(0, socket, Socket, 0, "A Socket instance created with socket_create.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, mode, IS_LONG, 0, "2", "The value of mode can be one of the following: possible values for mode 0 Shutdown socket reading 1 Shutdown socket writing 2 Shutdown socket reading and writing")
ZEND_END_ARG_INFO()
#endif
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_last_error, 0, 0, IS_LONG, 0)
	ZEND_ARG_OBJ_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, socket, Socket, 1, "null", "A Socket instance created with socket_create.")
ZEND_END_ARG_INFO()
