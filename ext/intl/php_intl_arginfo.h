 ...
 * Stub hash: 87558a7d5e76fe33c382515c2293ab6d01e064f9 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_grapheme_strlen, 0, 1, MAY_BE_LONG|MAY_BE_FALSE|MAY_BE_NULL)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, string, IS_STRING, 0, "The string being measured for length. It must be a valid UTF-8 string.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_grapheme_strpos, 0, 2, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, haystack, IS_STRING, 0, "The string to look in. Must be valid UTF-8.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, needle, IS_STRING, 0, "The string to look for. Must be valid UTF-8.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, offset, IS_LONG, 0, "0", "The optional offset parameter allows you to specify where in haystack to start searching as an offset in grapheme units (not bytes or characters). If the offset is negative, it is treated relative to the end of the string. The position returned is still relative to the beginning of haystack regardless of the value of offset.")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_grapheme_substr, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, string, IS_STRING, 0, "The input string. Must be valid UTF-8.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, offset, IS_LONG, 0, "Start position in default grapheme units. If offset is non-negative, the returned string will start at the offset'th position in string, counting from zero. If offset is negative, the returned string will start at the offset'th grapheme unit from the end of string.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, length, IS_LONG, 1, "null", "Length in grapheme units. If length is given and is positive, the string returned will contain at most length grapheme units beginning from offset (depending on the length of string). If length is given and is negative, then that many grapheme units will be omitted from the end of string (after the start position has been calculated when offset is negative). If offset denotes a position beyond this truncation, an empty string will be returned.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, locale, IS_STRING, 0, "\"\"")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_grapheme_strstr, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, haystack, IS_STRING, 0, "The input string. Must be valid UTF-8.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, needle, IS_STRING, 0, "The string to look for. Must be valid UTF-8.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, beforeNeedle, _IS_BOOL, 0, "false", "If true, grapheme_strstr returns the part of the haystack before the first occurrence of the needle (excluding the needle).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, locale, IS_STRING, 0, "\"\"")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_grapheme_extract, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, haystack, IS_STRING, 0, "String to search.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, size, IS_LONG, 0, "Maximum number items - based on the type - to return.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, type, IS_LONG, 0, "GRAPHEME_EXTR_COUNT", "Defines the type of units referred to by the size parameter:")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, offset, IS_LONG, 0, "0", "Starting position in haystack in bytes - if given, it must be zero or a positive value that is less than or equal to the length of haystack in bytes, or a negative value that counts from the end of haystack. If offset does not point to the first byte of a UTF-8 character, the start position is moved to the next character boundary.")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_idn_to_ascii, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, domain, IS_STRING, 0, "The domain to convert, which must be UTF-8 encoded.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, flags, IS_LONG, 0, "IDNA_DEFAULT", "Conversion options - combination of IDNA_* constants (except IDNA_ERROR_* constants).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, variant, IS_LONG, 0, "INTL_IDNA_VARIANT_UTS46", "Either INTL_IDNA_VARIANT_2003 (deprecated as of PHP 7.2.0) for IDNA 2003 or INTL_IDNA_VARIANT_UTS46 (only available as of ICU 4.6) for UTS #46.")
...
static const zend_function_entry ext_functions[] = {
	...
	ZEND_RAW_FENTRY("grapheme_str_split", zif_grapheme_str_split, arginfo_grapheme_str_split, 0, NULL, "/**\n * Split a string into an array\n * @return array|false\n */")
