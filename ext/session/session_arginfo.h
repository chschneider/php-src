 ...
 * Stub hash: 9fc441093ea1b80cc71f0a5958a591d8773f1262 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_session_regenerate_id, 0, 0, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, delete_old_session, _IS_BOOL, 0, "false", "Whether to delete the old associated session file or not. You should not delete old session if you need to avoid races caused by deletion or detect/avoid session hijack attacks.")
ZEND_END_ARG_INFO()
