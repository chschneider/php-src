 ...
 * Stub hash: 5523b022fc432eae8d90cc93a3bf17586d4cc0db */

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_strtotime, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, datetime, IS_STRING, 0, "A date/time string. Valid formats are explained in Date and Time Formats.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, baseTimestamp, IS_LONG, 1, "null", "The timestamp which is used as a base for the calculation of relative dates.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_idate, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, format, IS_STRING, 0, "The following characters are recognized in the format parameter string format character Description B Swatch Beat/Internet Time d Day of the month h Hour (12 hour format) H Hour (24 hour format) i Minutes I (uppercase i) returns 1 if DST is activated, 0 otherwise L (uppercase l) returns 1 for leap year, 0 otherwise m Month number N ISO-8601 day of the week (1 for Monday through 7 for Sunday) o ISO-8601 year (4 digits) s Seconds t Days in current month U Seconds since the Unix Epoch - January 1 1970 00:00:00 UTC - this is the same as time w Day of the week (0 on Sunday) W ISO-8601 week number of year, weeks starting on Monday y Year (1 or 2 digits - check note below) Y Year (4 digits) z Day of the year Z Timezone offset in seconds")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, timestamp, IS_LONG, 1, "null", "The optional timestamp parameter is an int Unix timestamp that defaults to the current local time if timestamp is omitted or null. In other words, it defaults to the value of time.")
ZEND_END_ARG_INFO()

#define arginfo_gmdate arginfo_date

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_mktime, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, hour, IS_LONG, 0, "The number of the hour relative to the start of the day determined by month, day and year. Negative values reference the hour before midnight of the day in question. Values greater than 23 reference the appropriate hour in the following day(s).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, minute, IS_LONG, 1, "null", "The number of the minute relative to the start of the hour. Negative values reference the minute in the previous hour. Values greater than 59 reference the appropriate minute in the following hour(s).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, second, IS_LONG, 1, "null", "The number of seconds relative to the start of the minute. Negative values reference the second in the previous minute. Values greater than 59 reference the appropriate second in the following minute(s).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, month, IS_LONG, 1, "null", "The number of the month relative to the end of the previous year. Values 1 to 12 reference the normal calendar months of the year in question. Values less than 1 (including negative values) reference the months in the previous year in reverse order, so 0 is December, -1 is November, etc. Values greater than 12 reference the appropriate month in the following year(s).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, day, IS_LONG, 1, "null", "The number of the day relative to the end of the previous month. Values 1 to 28, 29, 30 or 31 (depending upon the month) reference the normal days in the relevant month. Values less than 1 (including negative values) reference the days in the previous month, so 0 is the last day of the previous month, -1 is the day before that, etc. Values greater than the number of days in the relevant month reference the appropriate day in the following month(s).")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, year, IS_LONG, 1, "null", "The number of the year, may be a two or four digit value, with values between 0-69 mapping to 2000-2069 and 70-100 to 1970-2000. On systems where time_t is a 32bit signed integer, as most common today, the valid range for year is somewhere between 1901 and 2038.")
ZEND_END_ARG_INFO()

#define arginfo_gmmktime arginfo_mktime

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_checkdate, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, month, IS_LONG, 0, "The month is between 1 and 12 inclusive.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, day, IS_LONG, 0, "The day is within the allowed number of days for the given month.  Leap years are taken into consideration.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, year, IS_LONG, 0, "The year is between 1 and 32767 inclusive.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_localtime, 0, 0, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, timestamp, IS_LONG, 1, "null", "The optional timestamp parameter is an int Unix timestamp that defaults to the current local time if timestamp is omitted or null. In other words, it defaults to the value of time.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, associative, _IS_BOOL, 0, "false", "Determines whether the function should return a regular, numerically indexed array, or an associative one.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_parse, 0, 1, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, datetime, IS_STRING, 0, "Date/time in format accepted by DateTimeImmutable::__construct.")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_parse_from_format, 0, 2, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, format, IS_STRING, 0, "Documentation on how the format is used, please refer to the documentation of DateTimeImmutable::createFromFormat. The same rules apply.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, datetime, IS_STRING, 0, "String representing the date/time.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_timezone_name_from_abbr, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, abbr, IS_STRING, 0, "Time zone abbreviation.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, utcOffset, IS_LONG, 0, "-1", "Offset from GMT in seconds. Defaults to -1 which means that first found time zone corresponding to abbr is returned. Otherwise exact offset is searched and only if not found then the first time zone with any offset is returned.")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE_DOCCOMMENT(0, isDST, IS_LONG, 0, "-1", "Daylight saving time indicator. Defaults to -1, which means that whether the time zone has daylight saving or not is not taken into consideration when searching. If this is set to 1, then the utcOffset is assumed to be an offset with daylight saving in effect; if 0, then utcOffset is assumed to be an offset without daylight saving in effect. If abbr doesn't exist then the time zone is searched solely by the utcOffset and isDST.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_default_timezone_set, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, timezoneId, IS_STRING, 0, "The timezone identifier, like UTC, Africa/Lagos, Asia/Hong_Kong, or Europe/Lisbon. The list of valid identifiers is available in the .")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_sun_info, 0, 3, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, timestamp, IS_LONG, 0, "Unix timestamp.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, latitude, IS_DOUBLE, 0, "Latitude in degrees.")
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, longitude, IS_DOUBLE, 0, "Longitude in degrees.")
ZEND_END_ARG_INFO()
...
static const zend_function_entry ext_functions[] = {
	...
	ZEND_RAW_FENTRY("date_parse", zif_date_parse, arginfo_date_parse, 0, NULL, "/**\n * Returns associative array with detailed info about given date/time\n * @param string $datetime Date/time in format accepted by DateTimeImmutable::__construct.\n * @return array\n */")
	...
	ZEND_RAW_FENTRY("date_default_timezone_set", zif_date_default_timezone_set, arginfo_date_default_timezone_set, 0, NULL, "/**\n * Sets the default timezone used by all date/time functions in a script\n * @param string $timezoneId The timezone identifier, like UTC, Africa/Lagos, Asia/Hong_Kong, or Europe/Lisbon. The list of valid identifiers is available in the .\n * @return bool\n */")
...
static zend_class_entry *register_class_DatePeriod(zend_class_entry *class_entry_IteratorAggregate)
{
	...
	zend_string *property_start_name = zend_string_init("start", sizeof("start") - 1, true);
	...
	zend_string *property_current_name = zend_string_init("current", sizeof("current") - 1, true);
	...
	zend_string *property_end_name = zend_string_init("end", sizeof("end") - 1, true);
	...
	zend_string *property_interval_name = zend_string_init("interval", sizeof("interval") - 1, true);
	...
	zend_string *property_recurrences_name = zend_string_init("recurrences", sizeof("recurrences") - 1, true);
	...
	zend_string *property_include_start_date_name = zend_string_init("include_start_date", sizeof("include_start_date") - 1, true);
	...
	zend_string *property_include_end_date_name = zend_string_init("include_end_date", sizeof("include_end_date") - 1, true);
