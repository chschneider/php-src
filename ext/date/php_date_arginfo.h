 ...
 * Stub hash: c434c9c2b5029cc923661e3e006380dcd7485cc7 */

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_strtotime, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, datetime, IS_STRING, 0, "A datetime string. date.formats")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_parse, 0, 1, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, datetime, IS_STRING, 0, "Datetime in format accepted by DateTimeImmutable::__construct.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_parse_from_format, 0, 2, IS_ARRAY, 0)
	...
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, datetime, IS_STRING, 0, "String representing the datetime.")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_date_default_timezone_set, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO_DOCCOMMENT(0, timezoneId, IS_STRING, 0, "The timezone identifier, like UTC, AfricaLagos, AsiaHong_Kong, or EuropeLisbon. The list of valid identifiers is available in the .")
ZEND_END_ARG_INFO()
